    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Student ID: {student.studentId}</p>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-yellow-800">Follow-up Needed</h3>
                {student.followUpNotes && (
                  <p className="mt-1 text-sm text-yellow-700">{student.followUpNotes}</p>
                )}
              </div>
            </div>
          </CardContent>
        ...
        <CardContent>
          <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100">
              ...
              <dd className="text-4xl font-bold text-blue-900">{student.interactionCount || 0}</dd>
