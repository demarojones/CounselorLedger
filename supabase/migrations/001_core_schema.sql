...
-- Trigger to automatically calculate end_time
...
COMMENT ON TABLE tenants IS 'Stores information about each school/district using the system';
COMMENT ON TABLE users IS 'Application users linked to Supabase Auth with tenant assignment';
COMMENT ON TABLE students IS 'Student records for counseling interactions';
COMMENT ON TABLE contacts IS 'External contacts (parents, teachers, etc.)';
COMMENT ON TABLE reason_categories IS 'Interaction reason categories';
COMMENT ON TABLE reason_subcategories IS 'Detailed subcategories for interaction reasons';
COMMENT ON TABLE interactions IS 'All counseling interactions with students or contacts';

COMMENT ON COLUMN interactions.regarding_student_id IS 
  'For contact interactions, references which student the conversation was about';

COMMENT ON COLUMN tenants.contact_phone IS 'Primary phone number for administrative contact';
COMMENT ON COLUMN tenants.contact_address IS 'Physical address of the school or district';
COMMENT ON COLUMN tenants.contact_email IS 'Primary email address for administrative contact';
COMMENT ON COLUMN tenants.contact_person_name IS 'Name of the primary administrative contact person';
